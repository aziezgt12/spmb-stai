    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                <li>
                    <a href="<?= base_url() ?>" class="waves-effect"><i class="fa fa-tachometer"></i><span> Dashboard <span class="float-right menu-arrow"></span> </span></a>
                </li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <?php foreach ($submenu['menuLevel3'] as $dtlMenu) : ?>
                                        <li><a href="<?= $dtlMenu['dtlLink'] ?>"><?= $dtlMenu['dtlTitle'] ?></a></li>
                                    <?php endforeach ?>
                                </ul>
                            </li>
                        <?php } else { ?>
                            <li>
                                <a href="<?= $submenu['subMenuLink'] ?>" class="waves-effect">
                                    ...
                                    <i class="fa <?= $submenu['subMenuIcon'] ?>"></i></span> <span> <?= $submenu['subMenuTitle'] ?></span>
                                </a>
                            </li>
                        <?php } ?>
                    <?php endforeach; ?>
