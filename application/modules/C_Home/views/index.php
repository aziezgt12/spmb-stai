...
<div class="row">
    <div class="col-xl-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title mb-1">List Of Last Shipment</h4>
                <hr>
                <div class="vertical-scroll" style="width: 100%;">
                    <table class="table table-hover table-striped">
                        <thead>
                            <tr style="position: sticky; top:-2px; background-color:#2F4F4F; color: white;">
                                <th scope="col" style="width: 200px">Shipment Date</th>
                                <th scope="col">Vessel (Barge)</th>
                        ...
                        <tbody>
                            <?php foreach ($listOfShipment as $item) : ?>
                                <tr style="background-color: antiquewhite;">
                                    <td colspan="5"><?= setDateFormat($item['shipmentDate'], "d F Y")  ?></td>
                                </tr>
